...
<%
    ...
    if (pName == null || pName.trim().isEmpty()) {
        pName = "Cast Iron Kettlebell 16kg";
    }
...
<head>
    ...
    <title><%= isAdminDashboard ? "Admin Dashboard & Reviews" : "Shopping Cart & Checkout" %> | VT Fitness Mart</title>
...
<body class="flex flex-col min-h-full">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-6 py-10">
        ...
        <% if (isAdminDashboard) { %>
            <!-- ================= ADMIN DASHBOARD & CUSTOMER REVIEWS ================= -->
            <div class="space-y-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800 pb-6">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Live tracking of revenue metrics, order dispatch volume, and user feedback ratings.</p>
                    </div>
                ...
                <div class="lg:col-span-5 space-y-4">
                    <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 flex items-center gap-4">
                        <img src="<%= pImg.startsWith("http") ? pImg : (ctx + "/assets/images/" + pImg) %>" 
                             ...
                             onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=300&auto=format&fit=crop';">
