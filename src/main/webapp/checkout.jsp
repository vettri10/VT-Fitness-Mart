...
<head>
    ...
    <title>Secure Checkout | VT Fitness Mart</title>
...
<body class="flex flex-col min-h-full">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-6 py-10">
        <h1 class="text-2xl font-bold text-white mb-8">Order Checkout</h1>
        ...
        <% if (!hasItem) { %>
            <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-12 text-center max-w-md mx-auto">
                ...
                <p class="text-slate-300 font-semibold mb-6">No items selected for checkout</p>
        ...
        <% } else { %>
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <!-- Left: Selected Item Summary Card -->
                <div class="lg:col-span-5 space-y-4">
                    <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <a href="<%= ctx %>/catalog.jsp" class="text-xs text-red-400 hover:text-red-300 mt-2 inline-flex items-center gap-1.5 transition">
                                <i class="fa-solid fa-rotate-left"></i> Change Item
                            </a>
                        </div>
                ...
                <div class="lg:col-span-7 bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-6">
                    <div class="border-b border-slate-800 pb-4 flex items-center justify-between">
                        <h2 class="text-base font-bold text-white flex items-center gap-2">
                            <i class="fa-solid fa-clipboard-check text-red-500"></i> Delivery & Payment Details
                        </h2>
                        <span class="text-xs text-slate-400">Step 2 of 2</span>
                    </div>

                    <form action="<%= ctx %>/orders" method="POST" class="space-y-4">
                        ...
                        <!-- District, Pincode & Delivery Date -->
